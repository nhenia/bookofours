  ...
  return (
    <div className="fixed inset-0 bg-black flex items-center justify-center p-4 md:p-12 z-50 overflow-auto">
      <div className="w-full max-w-3xl min-h-[90vh] bg-[#f4f1ea] text-[#2b2622] p-8 md:p-16 shadow-[0_0_80px_rgba(0,0,0,0.5)] relative overflow-hidden flex flex-col">
        ...
        {/* Subtle Ruler - Top Left Sigil */}
        <div className="absolute top-4 left-4 z-20 flex items-start gap-3 opacity-30 pointer-events-none">
          <PlanetarySigil
            symbol={status.planetaryRuler.symbol}
            className="w-10 h-10 text-iron-gall -rotate-6"
          />
          <div className="max-w-[200px] mt-2">
            <p className="text-[10px] tracking-[0.05em] leading-relaxed font-serif text-iron-gall italic">
              {status.planetaryRuler.description}
            </p>
          </div>
        </div>
